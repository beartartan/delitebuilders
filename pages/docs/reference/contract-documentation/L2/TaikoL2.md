...
```solidity
function init(address _addressManager, struct DeliteL2.EIP1559Params _param1559) external
```
...
```solidity
function getEIP1559Config() public view virtual returns (struct DeliteL2.EIP1559Config)
```
