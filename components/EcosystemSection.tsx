...
export default function EcosystemSection() {
  const ecosystemData = [
    ...
    {
      icon: "/images/ecosystem/delite.svg",
      name: "Bridge",
      link: "https://bridge.test.delite.xyz",
      description: "Bridge is a dapp that lets you bridge tokens with Delite.",
    },
    {
    ...
    //   icon: "/images/ecosystem/delite.svg",
    //   name: "Swap",
    //   link: "https://swap.test.delite.xyz",
    //   description: "Swap is a dapp that lets you swap tokens on Delite.",
    // },
    {
